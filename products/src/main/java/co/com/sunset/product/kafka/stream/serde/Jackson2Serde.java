package co.com.sunset.product.kafka.stream.serde;
...
public class Jackson2Serde<T> implements Serde<T> {
   ...
   *
   * @param serdeForType Configures to deserialize the specified type.
   */
   ...
   *
   * @param objectMapper Specifies the ObjectMapper instance to use for all serializing and
   *     deserializing.
   * @param serdeForType Configures to deserialize the specified type.
   */
